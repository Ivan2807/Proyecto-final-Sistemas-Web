...
export default function Lista({ items = [], onEdit, onArchive, onRegistrar }) {
  ...
  return (
    <div>
      ...
      <h3 style={{ marginTop: 16 }}>Items ({filtro.length})</h3>
      <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
        ...
        {filtro.length === 0 && (
          <li style={{ padding: 10, color: '#6b0909' }}>
            No hay items activos para esta categoría.
          </li>
        )}
      </ul>
    </div>
